...
When contributing to [this project](https://github.com/engineervix/zm-csa), if you would like to make a non-trivial contribution, please first create an [issue](https://github.com/engineervix/zm-csa/issues) to discuss the change you wish to make before making the change (No need to do this if you are fixing a bug or typos, etc.).
...
3. Send a [pull request](https://github.com/engineervix/zm-csa/pulls) 🙏
